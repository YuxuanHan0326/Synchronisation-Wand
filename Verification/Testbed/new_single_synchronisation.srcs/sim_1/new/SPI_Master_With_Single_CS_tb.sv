...
`include "F:\FPGA\Verification\new_single_synchronisation\new_single_synchronisation.srcs\sources_1\new\SPI_driver.v"
...
module SPI_Master_With_Single_CS_TB ();
  ...
  parameter MAX_BYTES_PER_CS = 10;   // 2 bytes per chip select
  parameter CS_INACTIVE_CLKS = 10;  // Adds delay between bytes
  parameter CS_HOLD_CLKS = 10;
  ...
  logic [$clog2(MAX_BYTES_PER_CS+1)-1:0] w_Master_RX_Count, r_Master_TX_Count = 2'd2;
