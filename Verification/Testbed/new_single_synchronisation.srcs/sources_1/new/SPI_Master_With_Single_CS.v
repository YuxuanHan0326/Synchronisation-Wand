...
module SPI_Master_With_Single_CS
  ...
  localparam CS_HOLD     = 2'b10;
  localparam CS_INACTIVE = 2'b11;

  reg [1:0] r_SM_CS;
  reg r_CS_n;
  reg [$clog2(CS_INACTIVE_CLKS)-1:0] r_CS_Inactive_Count;
  reg [$clog2(CS_HOLD_CLKS)-1:0] r_CS_Hold_Count;
  ...
  begin
    ...
    begin
      ...
      CS_HOLD:
        begin
            if (r_CS_Hold_Count > 0) begin
                r_CS_Hold_Count <= r_CS_Hold_Count - 1'b1;
            end
            else begin
                r_SM_CS <= CS_INACTIVE;
