...
## Pmod header JA
# set_property -dict { PACKAGE_PIN AB22  IOSTANDARD LVCMOS33 } [get_ports { IMU1_CS }]; #IO_L10N_T1_D15_14 Sch=ja[1]
# set_property -dict { PACKAGE_PIN AB21  IOSTANDARD LVCMOS33 } [get_ports { IMU1_MISO }]; #IO_L10P_T1_D14_14 Sch=ja[2]
# set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { IMU1_MOSI }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3]
# set_property -dict { PACKAGE_PIN AB18  IOSTANDARD LVCMOS33 } [get_ports { IMU1_SCLK }]; #IO_L17N_T2_A13_D29_14 Sch=ja[4]
# set_property -dict { PACKAGE_PIN Y21   IOSTANDARD LVCMOS33 } [get_ports { IMU2_CS }]; #IO_L9P_T1_DQS_14 Sch=ja[7]
# set_property -dict { PACKAGE_PIN AA21  IOSTANDARD LVCMOS33 } [get_ports { IMU2_MISO }]; #IO_L8N_T1_D12_14 Sch=ja[8]
# set_property -dict { PACKAGE_PIN AA20  IOSTANDARD LVCMOS33 } [get_ports { IMU2_MOSI }]; #IO_L8P_T1_D11_14 Sch=ja[9]
# set_property -dict { PACKAGE_PIN AA18  IOSTANDARD LVCMOS33 } [get_ports { IMU2_SCLK }]; #IO_L17P_T2_A14_D30_14 Sch=ja[10]
...
#set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L19P_T3_34 Sch=jb_p[2]
