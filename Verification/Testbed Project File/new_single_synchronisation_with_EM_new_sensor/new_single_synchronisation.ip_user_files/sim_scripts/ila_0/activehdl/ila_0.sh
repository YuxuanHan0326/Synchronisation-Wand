...
#
# Script generated by Vivado on Sun Feb 23 21:55:12 +0000 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/new_single_synchronisation_with_EM_new_sensor/new_single_synchronisation.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
